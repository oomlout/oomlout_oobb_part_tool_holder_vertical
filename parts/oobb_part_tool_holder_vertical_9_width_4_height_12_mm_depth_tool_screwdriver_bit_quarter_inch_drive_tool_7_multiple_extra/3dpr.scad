...
difference() {
	...
	union() {
		#translate(v = [-45.0000000000, -35.7500000000, 0.0000000000]) {
			rotate(a = [-90, 0, 0]) {
				cylinder(h = 36.5000000000, r = 4.0000000000);
			}
		}
		#translate(v = [-30.0000000000, -35.7500000000, 0.0000000000]) {
			rotate(a = [-90, 0, 0]) {
				cylinder(h = 36.5000000000, r = 4.0000000000);
			}
		}
		#translate(v = [-15.0000000000, -35.7500000000, 0.0000000000]) {
			rotate(a = [-90, 0, 0]) {
				cylinder(h = 36.5000000000, r = 4.0000000000);
			}
		}
		#translate(v = [0.0000000000, -35.7500000000, 0.0000000000]) {
			rotate(a = [-90, 0, 0]) {
				cylinder(h = 36.5000000000, r = 4.0000000000);
			}
		}
