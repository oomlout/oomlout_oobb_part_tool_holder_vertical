...
difference() {
	...
	union() {
		#translate(v = [-45.0000000000, -4.0000000000, 0.0000000000]) {
			rotate(a = [-90, 0, 0]) {
				cylinder(h = 28, r = 4.7500000000);
			}
		}
		#translate(v = [-30.0000000000, -4.0000000000, 0.0000000000]) {
			rotate(a = [-90, 0, 0]) {
				cylinder(h = 28, r = 4.7500000000);
			}
		}
		#translate(v = [-15.0000000000, -4.0000000000, 0.0000000000]) {
			rotate(a = [-90, 0, 0]) {
				cylinder(h = 28, r = 4.7500000000);
			}
		}
